...
class Route(models.Model):
    ...
    total_distance = models.FloatField(null=True, blank=True) #i just realized that adding this is a lot more difficult than I initially thought since i need to do some serializer modifications too
